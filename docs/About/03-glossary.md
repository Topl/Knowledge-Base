...
Bifrost is the reference client implementation of the Topl protocol node, written in Scala. It is designed to accomplish three primary objectives:
...
## Genus
A service that provides a data layer between the Topl Blockchain and wallets, block explorers, or other dApps that require easy and well structured access to chain data.
